...
cubiertas por los 272 tests del backend (1 fallo, 9 errores, 2 \emph{skipped}),
medido con \texttt{jacoco-maven-plugin}. Cifra re-verificada con una
corrida real de \texttt{./mvnw clean test jacoco:report -Dmaven.test.failure.ignore=true}
sobre el commit vigente al cierre de esta entrega (\texttt{c2d76ad}) --
...
otros) y la cobertura real bajó a 61,30\,\%, bajo el umbral de 70\,\%
exigido para la Entrega Final -- se reporta con honestidad en vez de
repetir la cifra anterior sin artefacto respaldatorio.
...
La corrida vigente (\texttt{c2d76ad}) se versiona ahora como
\texttt{2026-08-25-cobertura-jacoco-cierre-entrega-final.md} con sus
artefactos XML/HTML/CSV en \texttt{docs/mediciones/jacoco/}.
...
\begin{tabular}{lrrrr}
\toprule
Métrica & 30-jul (pre-merge) & 13-ago (post-merge, \texttt{a2c88f8}) & \textbf{Vigente (\texttt{c2d76ad})} & Umbral \\
\midrule
Lines & 75,85\,\% (380/501) & 81,64\,\% (1014/1242) & \textbf{61,30\,\% (1476/2408)} & $\geq$70\,\% \textbf{No} \\
Branches & 49,02\,\% (50/102) & 58,05\,\% (137/236) & \textbf{38,16\,\% (232/608)} & -- \\
Complexity & 58,42\,\% (111/190) & 65,16\,\% (288/442) & \textbf{47,56\,\% (399/839)} & -- \\
\bottomrule
\end{tabular}
\caption{Cobertura JaCoCo: pre-merge, post-merge de 8 módulos de dominio, y corrida vigente al cierre de la Entrega Final (re-verificada con artefacto versionado)}
...
y la cobertura de líneas \textbf{bajó} de 81,64\,\% a 61,30\,\%, quedando
...
reporte real correspondiente al commit \texttt{c2d76ad}.
