...
Sobre A02 (parte pendiente, ahora cerrada): el header
\texttt{Strict-Transport-Security} se verificó activo en el despliegue
real de producción (\texttt{curl -sI https://biblora-sgb.onrender.com/},
18-ago-2026), no simulado ni asumido:
\texttt{strict-transport-security: max-age=315360000;\allowbreak
includeSubdomains; preload}. Con el header real confirmado en
producción, A02 queda resuelto en su totalidad (decisión de
arquitectura, preparación de backend y verificación de despliegue),
no solo preparado.
