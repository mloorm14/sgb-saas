...
cubiertas por los 247 tests del backend (0 fallos, 2 \emph{skipped}),
...
cierre de esta entrega (\texttt{0d1474d}) -- sube de los 203 tests / 50
clases citados en una versión anterior de este párrafo (commit
\texttt{a2c88f8}), porque 13 commits de backend adicionales (nuevos
controladores de catálogo, endpoint de aceptar/rechazar reservaciones,
autocompletado por ISBN, portal público, entre otros) se mergearon
después de esa medición.
...
La corrida vigente (\texttt{0d1474d}, tabla abajo) se generó en el mismo
formato pero su reporte HTML/XML no se re-versionó en este commit por
tiempo -- el número se toma directo de \texttt{target/site/jacoco/jacoco.csv}
de esa corrida real.
...
\begin{tabular}{lrrrr}
\toprule
Métrica & 30-jul (pre-merge) & 13-ago (post-merge, \texttt{a2c88f8}) & \textbf{Vigente (\texttt{0d1474d})} & Umbral \\
\midrule
Lines & 75,85\,\% (380/501) & 81,64\,\% (1014/1242) & \textbf{82,97\,\% (1208/1456)} & $\geq$70\,\% Sí \\
Branches & 49,02\,\% (50/102) & 58,05\,\% (137/236) & \textbf{64,75\,\% (180/278)} & -- \\
Complexity & 58,42\,\% (111/190) & 65,16\,\% (288/442) & \textbf{68,32\,\% (345/505)} & -- \\
\bottomrule
\end{tabular}
\caption{Cobertura JaCoCo: pre-merge, post-merge de 8 módulos de dominio, y corrida vigente al cierre de la Entrega Final}
...
entre pre-merge y post-merge (501$\to$1242), y siguió creciendo hasta
1456 con los commits posteriores al cierre, el porcentaje de cobertura
de líneas \textbf{subió} en cada corrida en vez de diluirse (75,85\,\%
$\to$ 81,64\,\%
$\to$ 82,97\,\%), permaneciendo muy por encima del umbral de $\geq$70\,\%
...
2. Seguridad (OWASP) & 5/6 controles con resultado cerrado; A02 parcial; ZAP ejecutado (0 High en producción, 2 High en local explicados) & \textbf{Parcial} & Parcial \\
