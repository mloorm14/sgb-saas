...
sobre HEAD \texttt{2ccac226}: 533
tests, 0 fallos, 12 \emph{skipped}, \textbf{76,13\,\%} de líneas
(2465/3238). Esta es la única cifra vigente de cobertura citada en el
...
\midrule
Lines & 2465/3238 & \textbf{76,13\,\%} & $\geq$70\,\% \textbf{Sí} \\
\bottomrule
\end{tabular}
...
fijado por el equipo para la Entrega Final (76,13\,\% al cierre). Las
capas \texttt{controller} y \texttt{security} quedan por encima del
umbral interno; \texttt{service} cruza el umbral en líneas, aunque
permanece como brecha conocida en ramas.
...
\textbf{Interpretación por capa (vigente al cierre, \autoref{tab:res-jacoco-capas-vigente}).} La medición vigente deja \texttt{controller} por encima del umbral interno (96,90\,\% de líneas; 71,57\,\% de ramas) y \texttt{service} cruza el umbral de líneas (70,35\,\%), aunque mantiene ramas como brecha conocida (46,10\,\%). El detalle numérico queda en el XML versionado para evitar mezclar cifras de cierre con cifras históricas dentro del texto defendido.
...
3. Cobertura (JaCoCo) & Medición vigente de cierre: 76,13\,\% de líneas (2465/3238) y 49,45\,\% de ramas (537/1086), respaldada por el XML versionado; cumple el objetivo interno de 70\,\% en líneas, aunque ramas queda como brecha conocida & \textbf{Parcial} & No \\
