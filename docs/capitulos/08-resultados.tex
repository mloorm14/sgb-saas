...
(2195/3899). Esta es la única cifra vigente de cobertura citada en el
...
\texttt{568e8c1f} descrita arriba. Los cortes anteriores permanecen en
...
\midrule
Lines & 2195/3899 & \textbf{56,30\,\%} & $\geq$70\,\% \textbf{No} \\
\bottomrule
\end{tabular}
\caption{Cobertura JaCoCo vigente al cierre de la Entrega Final (\texttt{Presentacion\_Final}, HEAD \texttt{568e8c1f}).}
...
\textbf{Interpretación por capa (vigente al cierre, \autoref{tab:res-jacoco-capas-vigente}).} Los tests de controlador agregados el 6 de septiembre de 2026 cambian el resultado de este criterio: \texttt{controller} y \texttt{security} alcanzan el umbral interno, mientras \texttt{service} permanece como brecha conocida. El detalle numérico queda en el XML versionado para evitar mezclar cifras de cierre con cifras históricas dentro del texto defendido.
