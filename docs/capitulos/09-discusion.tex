...
misma base de código, es del $78{,}34$\,\% de líneas
...
de implementación}: el equipo tuvo que validar de forma estricta
\texttt{@Procedure}/\texttt{@NamedStoredProcedureQuery} para las rutinas
principales y reservar \texttt{@Query} nativa con parámetros bindeados
solo para funciones tabulares, por las limitaciones documentadas de JPA
con funciones PostgreSQL \texttt{RETURNS TABLE} y procedimientos
