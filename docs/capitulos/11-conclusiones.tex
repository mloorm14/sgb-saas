...
esta corrección) ni la cobertura de pruebas ($78{,}34$\,\% de líneas),
pero tuvo un costo real de implementación: validar cuidadosamente
\texttt{@Procedure}/\texttt{@NamedStoredProcedureQuery} para las rutinas
principales y acotar \texttt{@Query} nativa a las funciones tabulares.
...
\begin{itemize}[leftmargin=1.2cm]
  ...
  \item Evidencia empírica reproducible y versionada como código: 5
    ...
    delta), cobertura JaCoCo real ($78{,}34$\,\% de líneas, rama
    \texttt{fix/errores-encontrados}), y auditoría de accesibilidad/rendimiento con
...
SGB-SaaS cierra esta Entrega Final como el software etiquetado en \texttt{v1.0.0}, producto de 8 ramas de
...
(\autoref{cap:ingenieria-requisitos}) y $78{,}34$\,\% de cobertura de
línea en 524 pruebas automatizadas del backend
