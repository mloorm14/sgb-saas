...
La amenaza de validez externa más relevante en este bloque es el tamaño
y método de muestreo de la evidencia de usabilidad (System Usability
Scale, SUS): la guía de esta entrega exige un mínimo de $N\geq15$
participantes, y esa evidencia ya se ejecutó con $N=15$
(\autoref{sec:res-usabilidad}: puntuación agregada 82,17, IC~95\,\%
$[80{,}08, 84{,}25]$, clasificación ``Excelente''), documentado como
cerrado en \texttt{OBS-08} de \texttt{docs/observaciones/OBSERVACIONES.md}
(commit \texttt{a5bb914}). El protocolo completo -- plantilla de
consentimiento informado, tarea de \emph{onboarding} de dos pasos,
código de participante anónimo -- se aplicó según lo definido, y el
tamaño de muestra cumple con exactitud el mínimo exigido por la guía.
Eso no elimina la amenaza de validez externa, solo la reformula: la
muestra se reclutó \textbf{por conveniencia dentro de la comunidad
UTEQ}, no de forma aleatoria ni fuera de ese contexto institucional.
\citet{baltes2022sampling} documentan, en su revisión crítica de
prácticas de muestreo en investigación de ingeniería de software, que
muestras pequeñas y no aleatorizadas -- exactamente el perfil de este
estudio SUS -- limitan severamente la generalización de cualquier
conclusión más allá de la muestra concreta estudiada, y recomiendan
reportar explícitamente el método de reclutamiento y sus límites en vez
de presentar el resultado como representativo de una población más
amplia sin justificarlo. Aplicando ese mismo criterio al resultado real
obtenido aquí: que $N=15$ cumpla el mínimo de la guía y que la
clasificación agregada sea ``Excelente'' no implica que ese resultado se
generalice más allá de esta muestra concreta -- son participantes de una
sola comunidad universitaria reclutados por conveniencia, no una muestra
aleatoria de la población general de usuarios de bibliotecas; no se
presenta la cifra de 82,17 como evidencia de que el sistema sería
igualmente bien percibido por una población de usuarios más amplia o
distinta a la de este contexto institucional.
