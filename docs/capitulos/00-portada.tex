...
{\normalsize\bfseries Integridad del PDF:}\\
{\small El digest SHA256 verificable de este archivo se publica fuera del
PDF, en \texttt{README.md} y \texttt{CITATION.cff}, para evitar una
auto-referencia de hash imposible de estabilizar dentro del propio
documento.}\\[0.5cm]
