...
{\normalsize\bfseries Tag de esta entrega:} \texttt{v0.9.0-rc (pre-release, v1.0.0 pendiente de correcciones finales)}\\[0.2cm]
{\small Commit base (HEAD de demo/interfaces-completas):}\\
% NOTA: hash estático al momento de este commit -- no hay mecanismo
% \gitHash de resolución en build time en este proyecto. Actualizar a
% mano antes de crear el tag v1.0.0 (ver docs/VERSIONING.md).
{\small\texttt{88f9daf}}\\[0.5cm]
