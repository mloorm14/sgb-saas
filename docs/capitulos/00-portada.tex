...
% El DOI de abajo corresponde al depósito de v0.9.0-rc (Tercera
% Entrega) y se declara así deliberadamente: no se generó un depósito
% Zenodo nuevo para v1.0.0 (decisión tomada para el cierre de la
% Entrega Final, ver docs/VERSIONING.md, sección de re-archivado). No
% es un DOI "pendiente" ni un placeholder -- es el DOI real y vigente
% del software, coherente con el criterio de OBS-05 en
% docs/observaciones/OBSERVACIONES.md: mejor declarar honestamente el
% DOI existente que fabricar uno nuevo sin depósito real detrás.
{\small \texttt{10.5281/zenodo.21712467 (depósito de v0.9.0-rc, usado deliberadamente para v1.0.0)}}\\[1cm]
