...
\begin{itemize}[leftmargin=1.2cm]
  ...
  \item \textbf{Inspección directa del código como último recurso
    ...
    presentada como si una HU real existiera. De los 43 requisitos, 8
    (\texttt{REQ-F-010}, \texttt{REQ-F-020} a \texttt{REQ-F-022},
    \texttt{REQ-F-025} a \texttt{REQ-F-028}) no citan ninguna HU/CU en la
    matriz de trazabilidad, y otros 5
...
\section{Los 43 requisitos: categorización MoSCoW}
...
propia matriz -- no se reproducen aquí las 43 fichas completas.
...
\hline
\multirow{2}{*}{Tipo} & Funcional (\texttt{REQ-F}) & 28 (65{,}1\,\%) \\
 & No funcional (\texttt{REQ-NF}) & 15 (34{,}9\,\%) \\
\hline
\multirow{4}{*}{Prioridad MoSCoW} & Must & 23 (53{,}5\,\%) \\
 & Should & 20 (46{,}5\,\%) \\
 & Could & 0 (0{,}0\,\%) \\
 & Won't & 0 (0{,}0\,\%) \\
\hline
\multirow{2}{*}{Estado (matriz)} & verificado & 23 (53{,}5\,\%) \\
 & implementado & 20 (46{,}5\,\%) \\
\hline
\textbf{Total} & & \textbf{43 (100{,}0\,\%)} \\
\hline
\end{tabular}
\end{center}

Ningún requisito usa las categorías \texttt{Could} o \texttt{Won't} de
MoSCoW -- dato real, no una omisión de esta tabla: los 43 requisitos del
...
el momento en que se escribió. Esa cifra quedó desactualizada por el
propio cierre descrito en la sección anterior: tras el commit
\texttt{e1f0c25} (posterior a \texttt{CHANGELOG-REQ.md}), el conteo real
de requisitos \texttt{verificado} es $23/43$, es decir 53{,}5\,\%, no
48{,}8\,\%. Se señala
aquí en vez de propagar silenciosamente la cifra desactualizada de la
fuente citada -- \texttt{CHANGELOG-REQ.md} en sí no se corrige en esta
tarea, por estar fuera de su alcance.
...
[restricción]'' del patrón formal de ISO/IEC/IEEE~29148:2018. El formato
...
evidencia directa (los 43 requisitos ya implementados y validados en CI
vía \texttt{scripts/validate-traceability.sh}). Las otras 2
