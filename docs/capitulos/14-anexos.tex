...
\hline
REQ-NF-002 & no funcional & Must & HU-AUTH-04 & CU-AUTH-04 & AuthController/AuthService (adr-007-cookies-jwt.md) & POST /api/auth/login; POST /api/auth/refresh; POST /api/auth/logout & AuthServiceTest.refreshConTokenValido & CRUD-ORM & docs/mediciones/sec/2026-07-21-cookie-refresh-token.md & verificado \\
\hline
...
\hline
REQ-NF-009 & no funcional & Should & N/A - decisión arquitectónica & N/A - decisión arquitectónica & docker-compose.yml + Dockerfiles (adr-012-estrategia-despliegue.md) & N/A & --- & N/A & --- & implementado \\
\hline
