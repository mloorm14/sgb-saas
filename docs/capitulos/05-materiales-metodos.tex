...
\begin{itemize}[leftmargin=1.2cm]
  ...
  \item \textbf{JaCoCo} (\texttt{jacoco-maven-plugin} en
    ...
    vigente es \textbf{81,64\,\%} de líneas (1014/1242) y
    \textbf{58,05\,\%} de ramas (137/236), por encima del umbral de
    ...
    casi nula, y una medición posterior que confirmó que el porcentaje se
    mantuvo (de hecho subió) tras el merge de los ocho módulos de dominio
