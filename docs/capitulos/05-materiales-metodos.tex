...
de \emph{Design Science Research} (DSR) de Peffers et al.\footnote{La
formulación de DSR de Peffers et al. (2007), \emph{A Design Science
Research Methodology for Information Systems Research}, no está incluida
todavía en \texttt{docs/bibliografia.bib}: esta tarea recibió instrucción
explícita de no agregar referencias nuevas más allá de la excepción de
Brooke (1996) para SUS, así que se nombra el enfoque metodológico por
autor y año sin \texttt{\textbackslash cite\{\}} formal. Queda pendiente
verificar su DOI real contra Crossref y agregarlo en una tarea futura,
con el mismo rigor aplicado al resto de este acervo.} -- un proceso
...
descriptivo. Las seis actividades se mapean así contra la evolución real
...
\begin{enumerate}[leftmargin=1.4cm]
  ...
  \item \textbf{Diseño y desarrollo.} Construcción incremental del
    ...
    evidencia empírica inicial), Entrega Final (\texttt{v1.0.0}, este
  ...
  \item \textbf{Demostración.} Ejecución de casos de uso reales de punta
    ...
    \texttt{docs/mediciones/backend/2026-07-29-flujo-prestamo-devolucion-multa-e2e.md}
    y
    \texttt{docs/mediciones/frontend/2026-07-30-flujo-frontend-prestamos-reservaciones-multas-e2e.md}.
...
\begin{itemize}[leftmargin=1.2cm]
  ...
  \item \textbf{JaCoCo} (\texttt{jacoco-maven-plugin} en
    ...
    $\geq$70\,\% de líneas para la Entrega Final. El resultado real
    vigente es \textbf{75,85\,\%} de líneas (380/501), por encima del
    umbral, tras un ciclo de trabajo dirigido específicamente a cinco
    clases de autenticación/autorización que partían de cobertura casi
    nula (\texttt{docs/mediciones/jacoco/2026-07-30-cobertura-jacoco-clases-seguridad-vigente.md}).
