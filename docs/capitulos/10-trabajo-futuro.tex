...
\section{Completar la evidencia de usabilidad (SUS, $N\geq15$) -- CERRADO}
\label{sec:tf-sus}

Una versión anterior de este capítulo declaraba el Bloque~5 de
evaluación empírica con $N=0$ de los $N\geq15$ participantes que exige
la guía, bloqueado hasta contar con un despliegue público funcional
donde participantes reales pudieran interactuar con el sistema.
\textbf{Ese estado ya no es real:} el \autoref{cap:resultados}
(\autoref{sec:res-usabilidad}) documenta hoy $N=15$ participantes
reales, por encima del mínimo exigido, reclutados con el protocolo ya
definido en su momento (plantilla de consentimiento informado, muestreo
por conveniencia dentro de la comunidad UTEQ, anonimización por código
de participante, \texttt{docs/etica/consentimientos/plantilla.md}) y
analizados con el instrumento SUS de 10 ítems \citep{brooke1996sus}:
puntuación media 82,17 (IC~95\,\% $[80{,}08, 84{,}25]$, $t$ de Student,
$df=14$), clasificación \textbf{Excelente} según la escala de adjetivos
de Bangor, muy por encima del umbral de aceptabilidad de 68. No queda
trabajo pendiente en este bloque; documentado como resuelto en
\texttt{OBS-08} de \texttt{docs/observaciones/OBSERVACIONES.md}.
