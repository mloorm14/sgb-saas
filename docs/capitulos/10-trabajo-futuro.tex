...
interactuar con el sistema. Una corrida previa se retiró por falta de
trazabilidad a un export crudo del instrumento
(ver \texttt{OBS-08} en
...
\section{Cerrar cobertura de ramas en servicios -- PENDIENTE}
\label{sec:tf-service-branch-coverage}

La medición JaCoCo vigente ya deja \texttt{service} por encima del
umbral de líneas (70,35\,\%), pero no de ramas: el XML versionado en
\texttt{docs/mediciones/jacoco/2026-08-27-jacoco-cierre-final/jacoco.xml}
marca 46,10\,\% de cobertura de ramas en
\texttt{com.uteq.backend.service}. Se mantiene como trabajo futuro
porque subir esa cifra exige diseñar casos adicionales para múltiples
combinaciones de reglas de negocio, errores y autorizaciones, no solo
agregar aserciones mecánicas. El objetivo mínimo operativo de la
siguiente iteración es superar 40\,\% de ramas de servicio de forma
estable y luego acercarse gradualmente al 70\,\% exigido por la rúbrica,
priorizando las ramas con riesgo funcional real.
