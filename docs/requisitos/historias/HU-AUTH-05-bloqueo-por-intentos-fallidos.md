...
Característica: Rate limiting de login (OWASP A07)
  ...
  Escenario: El sexto intento fallido consecutivo desde el mismo origen se bloquea
    Dado que el correo "victima@uteq.edu.ec" desde la IP "203.0.113.10" ya falló 5 veces seguidas en los últimos 15 minutos
  ...
  Escenario: El bloqueo es por correo+IP, no solo por correo
    Dado que un atacante falla 5 intentos contra "victima@uteq.edu.ec" desde su propia IP "198.51.100.5"
  ...
  Escenario: Un login exitoso resetea el contador de esa combinación
    Dado que el correo "lector@uteq.edu.ec" desde una IP tiene 2 intentos fallidos registrados
