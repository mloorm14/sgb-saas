-- V48: fix fn_auditoria_generica() para manejar cadena vacía en app.current_user_id
-- Error: "ERROR: invalid input syntax for type bigint: \"\""
-- Ocurre en verificación de correo (usuario no autenticado): AuditoriaAspect no
-- fija la variable, pero el trigger dispara en UPDATE usuarios y el cast
-- directo falla con cadena vacía. NULLIF convierte '' a NULL antes del cast.
